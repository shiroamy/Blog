...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || '7a5ee97e5fed4ad7a2fb6cee22a57ab7',
  ...
  LANG: process.env.NEXT_PUBLIC_LANG || 'zh-Hant-TW', // e.g 'zh-CN','en-US'  see /lib/lang.js for more.
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi,此為菜鳥打工人厭世紀錄',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ji3g4gp', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '菜鳥打工人;厭世生存記', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://gpblog.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'writeup, cybersecurity, infomation security, gp', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'shiroamy@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/shiroamy', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'shiroamy/Blog', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOKRuUIQ', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
        process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOKRuUIc4CZOI9', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '菜鳥打工仔 | 資安初心者 | 讀沽酒哮風雲外', // 站点描述，被notion中的页面描述覆盖
