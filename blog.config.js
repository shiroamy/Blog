...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '7a5ee97e5fed4ad7a2fb6cee22a57ab7',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '打工仔厭世生存日記', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://gpblog.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'writeup, cybersecurity, infomation security, blog, gp', // 网站关键词 英文逗号隔开
